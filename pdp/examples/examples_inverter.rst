Compute the efficiency of an inverter rated at 2500W connected to a PV module of 1000Wc
---------------------------------------------------------------------------------------
.. code-block:: python
    :linenos:
    :emphasize-lines: 7
...
Compute the input of an inverter rated at 2500W from its output
---------------------------------------------------------------
.. code-block:: python
    :linenos:
    :emphasize-lines: 7
