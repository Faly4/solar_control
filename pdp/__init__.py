...
my_file5 = pkg / "data" / "iut_load.npy"
my_file6 = pkg / "data" / "iut_pv.npy"
iut_load = numpy.load(my_file5, allow_pickle=True)
iut_pv = numpy.load(my_file6, allow_pickle=True)


# location1 = os.path.dirname(os.path.realpath(__file__))
# my_file5 = os.path.join(location1, 'data', 'iut_load.npy')
# my_file6 = os.path.join(location1, 'data', 'iut_pv.npy')
# iut_load = numpy.load(my_file5, allow_pickle=True)
# iut_pv = numpy.load(my_file6, allow_pickle=True)
